        ...
        <div className="container">
          <div className="banner-content">
            ...
            <div className="social-icons">
              ...
              <a href="#" className="fb"><i className="fa fa-facebook"></i> 27</a>
              <a href="#" className="twt"><i className="fa fa-twitter"></i> 13</a>
              <a href="#" className="g-plus"><i className="fa fa-google-plus"></i> 9</a>
              <a href="#" className="pint"><i className="fa fa-pinterest"></i> 4</a>
              <a href="#" className="linkdin"><i className="fa fa-linkedin"></i> 2</a>
              <a href="#" className="last-one"><i className="fa fa-stumbleupon"></i> 2</a>
            </div>
